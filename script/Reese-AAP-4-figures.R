...
landcover.light <- rgdal::readOGR('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/',layer='uav1-flight-polygon')
landcover.medium <- rgdal::readOGR('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/',layer='uav2-flight-polygon')
landcover.heavy <- rgdal::readOGR('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/',layer='uav3-flight-polygon')
landcover.extreme <- rgdal::readOGR('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/',layer='uav4-flight-polygon')
...
grDevices::pdf('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/figures/Figure 1.pdf')
...
grDevices::pdf('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/figures/Figure 2.pdf',height=4,width=6)
graphics::par(mfrow=c(1,1),bg=NA,mai=c(0.10,0.10,0.10,0.10),oma=c(0.5,0.5,0.5,0.5))
...
grDevices::pdf('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/figures/Figure 3.pdf',height=16,width=12)
...
grDevices::pdf('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/figures/Figure 4.pdf',width=12,height=6)
...
grDevices::pdf('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/figures/Figure 5.pdf',height=16,width=12)
...
grDevices::pdf('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/figures/Figure 6.pdf')
...
grDevices::pdf('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/figures/Figure 7.pdf')
graphics::par(mfrow=c(1,1),bg=NA,mai=c(0.10,0.10,0.10,0.10),oma=c(0.5,0.5,0.5,0.5))
...
grDevices::pdf('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/figures/Figure 8/Figure 8-structure.pdf',width=18,height=18)
graphics::par(mfrow=c(3,1),bg=NA,mai=c(0.10,0.10,0.10,0.10),oma=c(0.5,0.5,0.5,0.5))

graphics::plot(1,type="n",xlab='',ylab='',xlim=c(0,20),ylim=c(0,10),xaxs="i",yaxs="i",axes=F,main='')
graphics::text(0.5,9.25,'a',cex=6)
graphics::box(lwd=2)

graphics::plot(1,type="n",xlab='',ylab='',xlim=c(0,20),ylim=c(0,10),xaxs="i",yaxs="i",axes=F,main='')
graphics::text(0.5,9.25,'b',cex=6)
graphics::box(lwd=2)

graphics::plot(1,type="n",xlab='',ylab='',xlim=c(0,20),ylim=c(0,10),xaxs="i",yaxs="i",axes=F,main='')
graphics::text(0.5,9.25,'c',cex=6)
graphics::box(lwd=2)
...
odm.uav1.20m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/OpenDroneMap/ODM_UAV1-20m.tif')
odm.uav1.35m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/OpenDroneMap/ODM_UAV1-35m.tif')
odm.uav1.50m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/OpenDroneMap/ODM_UAV1-50m.tif')
...
grDevices::pdf('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/figures/Figure S1.pdf',height=16,width=12)
graphics::par(mfrow=c(3,2),bg=NA,mai=c(0.00,0.50,0.50,0.00),oma=c(0.5,0.5,0.5,0.5))
...
grDevices::pdf('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/figures/Figure S2.pdf',height=16,width=12)
graphics::par(mfrow=c(3,2),bg=NA,mai=c(0.00,0.50,0.50,0.00),oma=c(0.5,0.5,0.5,0.5))
...
grDevices::pdf('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/figures/Figure S3.pdf',height=16,width=12)
graphics::par(mfrow=c(3,2),bg=NA,mai=c(0.00,0.50,0.50,0.00),oma=c(0.5,0.5,0.5,0.5))
...
grDevices::pdf('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/figures/Figure S4.pdf',height=20,width=10)
...
# odm.uav1.50m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/OpenDroneMap/ODM_UAV1-50m.tif')
# 
# odm.uav2.20m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/OpenDroneMap/ODM_UAV2-20m.tif')
# odm.uav2.35m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/OpenDroneMap/ODM_UAV2-35m.tif')
# odm.uav2.50m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/OpenDroneMap/ODM_UAV2-50m.tif')
# 
# odm.uav3.20m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/OpenDroneMap/ODM_UAV3-20m.tif')
# odm.uav3.35m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/OpenDroneMap/ODM_UAV3-35m.tif')
# odm.uav3.50m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/OpenDroneMap/ODM_UAV3-50m.tif')
# 
# odm.uav4.20m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/OpenDroneMap/ODM_UAV4-20m.tif')
# odm.uav4.35m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/OpenDroneMap/ODM_UAV4-35m.tif')
# odm.uav4.50m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/OpenDroneMap/ODM_UAV4-50m.tif')
# 
# odm.uav1.20m.slope <- raster::terrain(odm.uav1.20m,'slope')
# odm.uav1.20m.aspect <- raster::terrain(odm.uav1.20m,'aspect')
# odm.uav1.20m.hillshade <- raster::hillShade(odm.uav1.20m.slope,odm.uav1.20m.aspect,angle=15)
...
# app.uav1.20m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/AgisoftPhotoscanPro/APP_UAV1-20m.tif')
# app.uav1.35m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/AgisoftPhotoscanPro/APP_UAV1-35m.tif')
# app.uav1.50m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/AgisoftPhotoscanPro/APP_UAV1-50m.tif')
# 
# app.uav2.20m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/AgisoftPhotoscanPro/APP_UAV2-20m.tif')
# app.uav2.35m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/AgisoftPhotoscanPro/APP_UAV2-35m.tif')
# app.uav2.50m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/AgisoftPhotoscanPro/APP_UAV2-50m.tif')
# 
# app.uav3.20m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/AgisoftPhotoscanPro/APP_UAV3-20m.tif')
# app.uav3.35m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/AgisoftPhotoscanPro/APP_UAV3-35m.tif')
# app.uav3.50m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/AgisoftPhotoscanPro/APP_UAV3-50m.tif')
# 
# app.uav4.20m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/AgisoftPhotoscanPro/APP_UAV4-20m.tif')
# app.uav4.35m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/AgisoftPhotoscanPro/APP_UAV4-35m.tif')
# app.uav4.50m <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/results/AgisoftPhotoscanPro/APP_UAV4-50m.tif')
# 
...
# grDevices::pdf('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/figures/Figure_EX.pdf')
# graphics::par(mfrow=c(1,1),bg=NA,mai=c(0.10,0.10,0.10,0.10),oma=c(0.5,0.5,0.5,0.5))
# 
# graphics::plot(1,type="n",xlab='',ylab='',xlim=c(xmin(extent(dtm.difference.cropped)),xmax(extent(dtm.difference.cropped))),ylim=c(ymin(extent(dtm.difference.cropped)),ymax(extent(dtm.difference.cropped))),xaxs="i",yaxs="i",axes=F,main='')
# raster::plot(dtm.difference.cropped,col=heatcolors,legend=F,add=T)
