...
# raster::writeRaster(dtm.interpolated,'/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-1')
# dtm.interpolated <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-1')
# 
...
# raster::writeRaster(dtm.interpolated,'/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-2',overwrite=T)
# 
# dtm.interpolated <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-2')
# dtm.difference <- dtm - dtm.interpolated
# dtm.difference.na <- dtm.difference
# dtm.difference.na[dtm.difference.na < 0 ] <- NA
# dtm.incomplete <- raster::mask(dtm.interpolated,dtm.difference.na)
...
# gappedDEM.final[gappedDEM.df.new$CELL] <- gappedDEM.df.new$ELEVATION.pred
# dtm.interpolated <- gappedDEM.final
# raster::writeRaster(dtm.interpolated,'/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-3',overwrite=T)
# 
# dtm.interpolated <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-3')
# dtm.difference <- dtm - dtm.interpolated
# dtm.difference.na <- dtm.difference
# dtm.difference.na[dtm.difference.na < 0 ] <- NA
# dtm.incomplete <- raster::mask(dtm.interpolated,dtm.difference.na)
...
# gappedDEM.final[gappedDEM.df.new$CELL] <- gappedDEM.df.new$ELEVATION.pred
# dtm.interpolated <- gappedDEM.final
# raster::writeRaster(dtm.interpolated,'/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-4',overwrite=T)
# 
# dtm.interpolated <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-4')
# dtm.difference <- dtm - dtm.interpolated
# dtm.difference.na <- dtm.difference
# dtm.difference.na[dtm.difference.na < 0 ] <- NA
# dtm.incomplete <- raster::mask(dtm.interpolated,dtm.difference.na)
...
# gappedDEM.final[gappedDEM.df.new$CELL] <- gappedDEM.df.new$ELEVATION.pred
# dtm.interpolated <- gappedDEM.final
# raster::writeRaster(dtm.interpolated,'/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-5',overwrite=T)
# 
# dtm.interpolated <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-5')
# dtm.difference <- dtm - dtm.interpolated
# dtm.difference.na <- dtm.difference
# dtm.difference.na[dtm.difference.na < 0 ] <- NA
# dtm.incomplete <- raster::mask(dtm.interpolated,dtm.difference.na)
...
# gappedDEM.final[gappedDEM.df.new$CELL] <- gappedDEM.df.new$ELEVATION.pred
# dtm.interpolated <- gappedDEM.final
# raster::writeRaster(dtm.interpolated,'/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-6',overwrite=T)
# 
# dtm.interpolated <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-6')
# dtm.difference <- dtm - dtm.interpolated
# dtm.difference.na <- dtm.difference
# dtm.difference.na[dtm.difference.na < 0 ] <- NA
# dtm.incomplete <- raster::mask(dtm.interpolated,dtm.difference.na)
...
# gappedDEM.final[gappedDEM.df.new$CELL] <- gappedDEM.df.new$ELEVATION.pred
# dtm.interpolated <- gappedDEM.final
# raster::writeRaster(dtm.interpolated,'/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-7',overwrite=T)

# dtm.interpolated <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-7')
# dtm.difference <- dtm - dtm.interpolated
# dtm.difference.na <- dtm.difference
# dtm.difference.na[dtm.difference.na < 0 ] <- NA
# dtm.incomplete <- raster::mask(dtm.interpolated,dtm.difference.na)
...
# gappedDEM.final[gappedDEM.df.new$CELL] <- gappedDEM.df.new$ELEVATION.pred
# dtm.interpolated <- gappedDEM.final
# raster::writeRaster(dtm.interpolated,'/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-8',overwrite=T)
# 
# dtm.interpolated <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-8')
# dtm.difference <- dtm - dtm.interpolated
# dtm.difference.na <- dtm.difference
# dtm.difference.na[dtm.difference.na < 0 ] <- NA
# dtm.incomplete <- raster::mask(dtm.interpolated,dtm.difference.na)
...
# gappedDEM.final[gappedDEM.df.new$CELL] <- gappedDEM.df.new$ELEVATION.pred
# dtm.interpolated <- gappedDEM.final
# raster::writeRaster(dtm.interpolated,'/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-9',overwrite=T)
# 
# dtm.interpolated <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-iteration-9')
# dtm.difference <- dtm - dtm.interpolated
# dtm.difference.na <- dtm.difference
# dtm.difference.na[dtm.difference.na < 0 ] <- NA
# dtm.incomplete <- raster::mask(dtm.interpolated,dtm.difference.na)
...
# gappedDEM.final[gappedDEM.df.new$CELL] <- gappedDEM.df.new$ELEVATION.pred
# dtm.interpolated <- gappedDEM.final
# raster::writeRaster(dtm.interpolated,'/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-final',overwrite=T)
# 
dtm.interpolated <- raster::raster('/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/dtm-predicted-final')
...
rgdal::writeOGR(as(total.tower.rubble,'SpatialPolygonsDataFrame'),'/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/',layer='5MT01917-tower',driver='ESRI Shapefile',overwrite=T)
...
rgdal::writeOGR(lower.level.no.holes,'/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/',layer='5MT01917-lower-level',driver='ESRI Shapefile',overwrite=T)
rgdal::writeOGR(upper.level.no.holes,'/Users/kmreese/Documents/PROJECTS/CURRENT/Reese-AAP/output/spatial-products/',layer='5MT01917-upper-level',driver='ESRI Shapefile',overwrite=T)
